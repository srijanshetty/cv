...
\itemlist {
    ...
    \textsc{---}         & Achieved AIR \textbf{54 in 9th} National Science Olympiad.\\
}
...
\lproject {Monsoon 2012-2013}
          ...
          {\textsc{Manufacturing Process I}, Professor Kallol Mondal}
          {
               \begin{itemize}[leftmargin=0.5cm]
                   ...
                   \item Prototyped the design over the course of six week using meturllurgical processses.
               \end{itemize}
           }
...
\lproject {Winter 2012-2013}
          ...
          {
               \begin{itemize}[leftmargin=0.5cm]
                   \item Designed a model for a Simple Lawn Mower which could convert translatory force applied to it
                       into rotatory motion of it's blades, in AutoCAD.
                   \item Prototyped the design over the course of six week using mechanical processses.
...
\lproject {Monsoon 2011-2012}
          ...
          {
               \begin{itemize}[leftmargin=0.5cm]
                   \item Illustrated the existence of a fundamental similarity in all situtations by a gross simplification.
...
\iproject {August 2013}
          {ShuffleRun}
          {
              \begin{itemize}[leftmargin=0.5cm]
                  ...
                  \item Pitched ShuffleRun --- a music player which selects tracks on the basis of the user's running speed to recieve
...
\iproject {2014}
          {Head, Major Events and Competitions, Antaragni '14}
          {
               \begin{itemize}[leftmargin=0.5cm]
                    ...
                    \item Introduced Chreo Nite to the arsenal of competitions held in Antaragni.
                    \item Promoted Road Safety as a part of the social campaign of Antaragni -- Zara Sambhal Ke by conducting
                        public polls and spreading general awarness about the same.
