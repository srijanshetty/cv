...
\scproject
    ...
    {
         Conceived and implemented a peer-to-peer protocol for file and media transfer in Node.js to share
...
\scproject
    ...
    {}
    {
          Generated raw IP packets with spoofed IP addresses to exploit test machines with ARP Poisoning,
