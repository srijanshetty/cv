...
\begin{tabular}{>{\raggedleft}p{2.2cm}p{14cm}}
    ...
    \textsc{Fall 2012}   & \textbf{Academic Mentor}, \textbf{Fundamentals of Computer Science (ESC101)}. \\
                         & \footnotesize{Tutored students in ESC101, which covered the basic concepts of
                            programming.}\\
...
\begin{tabular}{>{\raggedleft}p{2.2cm}|p{14cm}}
    \textsc{July 2013} & Website of Udghosh, annual sports-fest IIT Kanpur \footnotesize{\href{www.udghosh.org} {Webpage} } \\
\end{tabular}
