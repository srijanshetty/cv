...
% PAGE GEOMETRY
\usepackage[top=0.3cm, bottom=0.3cm, lmargin=0.4cm, rmargin=0.5cm,ignoreheadfoot]{geometry} % The page Geometry
...
\gitproject
    {\href{http://gyph2.herokuapp.com} {\footnotesize{[http://gyph2.herokuapp.com]}}}
...
\gitproject
    {\href{https://github.com/srijanshetty/ShuffleRun} {\footnotesize{[https://github.com/srijanshetty/ShuffleRun]}}}
    {ShuffleRun}
    {
        \begin{itemize}[leftmargin=0.5cm]
...
\gitproject
    {\href{https://github.com/navya} {\footnotesize{[https://github.com/navya]}}}
