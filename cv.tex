...
\iproject {Jul 2014}
          ...
          {
               \begin{itemize}[leftmargin=0.5cm]
                   \item Scraped the institute academic records to create a database of all course offered by the
                       institute.
                   \item Created an AngularJS based frontend for the scraped data with a focus on ease of use
                       and accessibility.
...
\iproject {Aug 2013}
          ...
          {
              \begin{itemize}[leftmargin=0.5cm]
                  \item Designed a web app which selects a music track from a user's library based on his running speed.
...
\lproject {Summer 2012}
          ...
          {Professor Manindra Agarwal, Professor T. V. Prabhakar}
          {
              \begin{itemize}[leftmargin=0.5cm]
                  ...
                  \item Conducted session on the extending VANI for the benefit of students.
              \end{itemize}
          }
...
\iproject {Summer 2012}
          {GNU/Linux Exploration, Programming Club, IIT Kanpur}
          {
              \begin{itemize}[leftmargin=0.5cm]
                  ...
                  \item
                      \href{https://docs.google.com/document/d/1ZHO9w36aoq3oaZBR4Um1AOmDfiTDAEgM6baQAu3icw4/edit?usp=sharing}{https://docs.google.com/document/d/1ZHO9w36aoq3oaZBR4Um1AOmDfiTDAEgM6baQAu3icw4/edit?usp=sharing}
              \end{itemize}
          }
