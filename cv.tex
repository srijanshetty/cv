...
\usepackage[top=0.3cm, bottom=0.3cm, lmargin=0.5cm, rmargin=1.3cm]{geometry} % The page Geometry
...
\iproject {2014}
          {Head, Major Events and Competitions, Antaragni '14}
          {
               \begin{itemize}[leftmargin=0.5cm]
                    ...
                    \item Coordinated the conduction of fifty competitions and nine major events with a three tier team comprising of 50 coordinators, 200 secretaries and 1000 volunteers.
...
\iproject {2013 -- 2014}
          {Member, Gymkhana Review Committee (GRC)}
          {
               \begin{itemize}[leftmargin=0.5cm]
                   ...
                   \item Chaired the meetings on \textbf{Extended Orientation of Incoming Freshmen} and contributed actively as a member of academic, senate and activities sub-committees of the GRC.
               \end{itemize}
          }
